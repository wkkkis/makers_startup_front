...
<img className='header__logo' src={Logo} /></div>
      ...
      <div className="header__icons"><MdOutlineShoppingBag className="header__cart-icon"/><BiUserCircle className="header__user-icon"/></div>
    </div>
